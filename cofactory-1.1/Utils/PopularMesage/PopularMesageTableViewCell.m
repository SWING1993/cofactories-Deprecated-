...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _commentLabel = [[UILabel alloc]initWithFrame:CGRectMake(kScreenW-60, 10, 50, 20)];
        _commentLabel.font = kSmallFont;
        _commentLabel.textColor = [UIColor grayColor];
        _commentLabel.textAlignment = 1;
        [self addSubview:_commentLabel];
        
        _interestLabel = [[UILabel alloc]initWithFrame:CGRectMake(kScreenW-120, 10, 50, 20)];
        _interestLabel.font = kSmallFont;
